...
import { AddDoctor, CheckIfDoctorAccountIsApplied, UpdateDoctor } from "../../apicalls/doctors";
    ...
    return (
        <div className='bg-white p-3'>
            {(!alreadyApplied || alreadyApproved) && (
                <>
                    <h3 className='uppercase my-1'>{alreadyApproved ? "Update your information" : "Apply as a doctor"}</h3>
                    <hr />
